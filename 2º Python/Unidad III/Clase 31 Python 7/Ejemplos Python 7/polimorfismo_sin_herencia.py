...
vehiculo1.desplazamiento() #Método del objeto

vehiculo2 = Moto() #Instancia de la clase Moto
vehiculo2.desplazamiento() #Método del objeto
...
#Cada uno de ellos tendrá su propio método desplazamiento
...
def moverse(vehiculo): #Recibe un objeto como parámetro, no sabemos de qué tipo es, no tenemos que especificarlo: ¿a qué método desplazamiento llamará, a cuál de los tres?
    vehiculo.desplazamiento()

#Programa principal (empleando polimorfismo)
#Gracias al polimorfismo, como un objeto puede tener la capacidad de cambiar de forma y de comportarse de diferente forma dependiendo del contexto va a saber en todo momento a que método desplazamiento tiene que llamar:
